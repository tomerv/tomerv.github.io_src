...
# Tomer Vromen build configuration file, created by
# `ablog start` on Fri Apr 10 17:59:28 2020.
#
...
ablog_website = '../tomerv.github.io'

# A path relative to the configuration directory for blog archive pages.
#blog_path = 'blog'

# The "title" for the blog, used in active pages.  Default is ``'Blog'``.
blog_title = u'Tomer Vromen'

# Base URL for the website, required for generating feeds.
# e.g. blog_baseurl = "http://example.com/"
blog_baseurl = u'https://tomerv.github.io/'
...
blog_authors = {
    'Tomer Vromen': ('Tomer Vromen', None),
}
...
project = u'Tomer Vromen'
copyright = u'2020, Tomer Vromen'
author = u'Tomer Vromen'
...
htmlhelp_basename = 'TomerVromendoc'
